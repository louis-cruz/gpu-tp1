...
void launch(double (*func)(int, double, int, int), string variation, long num_steps, int threads, int stepsPerThread, int rounds){
    ...
    for(int i=0;i<rounds;i++){
      ...
      printf("PI: %f\n",func(num_steps, step, threads, stepsPerThread));
      //func(num_steps, step, threads, stepsPerThread);
